...
import { LayoutDashboard, FileText, Search, Settings, LogOut, Briefcase } from 'lucide-react';
      ...
      <aside className="hidden md:flex w-60 bg-card border-r border-border flex-col">
        ...
        <div className="p-4 border-t border-gray-200 space-y-1">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:bg-red-50 hover:text-red-600 transition-colors"
          >
